...
class MetropolisSampler(Resampler):
    ...
    def resample(
        ...
        old_log_lkl = self.model.batch_total_log_lkl(index_data, old_locations, data)
        new_log_lkl = self.model.batch_total_log_lkl(index_data, proposals, data)
    ...
    def acceptance_rates(self, index_data, proposals, old_locations, data):
        old_log_lkl = self.model.batch_total_log_lkl(index_data, old_locations, data)
        new_log_lkl = self.model.batch_total_log_lkl(index_data, proposals, data)
